...
class Agenda {
  ...
  void editarContato() {
    ...
    _contatos[indice].telefone = validarTelefone();


    if (_contatos[indice] is ContatoPessoal) {

      ContatoPessoal contato =
          _contatos[indice] as ContatoPessoal;

      stdout.write('Novo CPF: ');
      contato.cpf = stdin.readLineSync() ?? '';
    ...
    if (_contatos[indice] is ContatoEmpresarial) {
      ...
      ContatoEmpresarial contato =
          _contatos[indice] as ContatoEmpresarial;


      stdout.write('Novo CNPJ: ');
      contato.cnpj = stdin.readLineSync() ?? '';
